...
- Stores a compact JSON timeline in the `as_qs_relay` cookie.
...
- The relay stores up to 20 compact touchpoints and trims older entries if the cookie approaches browser size limits.
